...
define('whois',"mac=042b58120244&globalIP=179.246.217.12&localIP=192.168.1.58")/
setup();
...
function start()
{
    ...
    #fwrite($fp,  $whois);
    #fclose($fp);
	//mac=042b58120244&globalIP=179.246.217.12&localIP=192.168.1.58
    ...
    {
        $ext = $ep->getMessage();
        sendData($memory, $cpuUsage, $htt,'type',whois, $ext);
    }
}
